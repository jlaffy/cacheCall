...
#' @param pipeName Can be the name of the parent function or the name of the pipeline if there is one. Can also simply be an ID for a series of functions and files that should be grouped together. Defaults to \code{NULL}.
#' @param cachePath a character string providing path to the Cache directory.
#' @param ... arguments that will be passed to fnName call if it is executed.
#'
#' @return the output of the function call, either from a read-in file or from an executed call. If the latter, the corresponding file will also be saved in \code{cachePath}.
#' @export
#'
#' @examples
